...
class Page {
    ...
    // 默认分页变量名
    protected $varPage;
//edit by porter at 2014-01-09 10:37:52 添加manySearch方法需用的参数Limit
    public $limit;
    /**
     * 架构函数
     * @access public
     ...
     * @access public
     */
    public function show($showUrl = false) {
        ...
        if ($downRow <= $this->totalPages){
            $downPage   =   "<li id='page-nav'><a href='".str_replace('__PAGE__',$downRow,$url)."'>".$this->config['next']."</a></li>";
        }else{
            $downPage   =   '';
        }
        // << < > >>
