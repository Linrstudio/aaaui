    ...
    SearchControl.prototype = {
                    ...
                    '<div id="BMapLib_normalBox" class="BMapLib_sc_t sc_box_bg">',
                        '<div id="BMapLib_sc0">',
                            '<table style="width:100%;" border="0" cellpadding="0" cellspacing="0">',
                                '<tr>',
                                    '<td width="100%" style="padding:15px 0;display:block;border:1px solid #ddd;border-bottom:none;">',
                                        '<h4 style="display:block;margin-bottom:8px;padding-left:15px;font-weight:normal;">请选择具体城市：</h4>',
                                        '<div id="BMapLib_cityTab" class="BMapLib_cityTab" style="position:relative;">',
                                            '<span style="background:url(http://kuanter.com/images/selectCityBg.png) no-repeat right center;padding-left:15px;display:inline-block;*display:inline;*zoom:1;padding-right: 35px;cursor:pointer;">北京市</span>',
                                        '</div>',
                                    '</td>',
                                '</tr>',
                                '<tr>',
                                    '<td width="100%" style="padding:15px 0;display:block;border:1px solid #ddd;">',
                                        '<h4 style="display:block;margin-bottom:10px;padding-left:15px;font-weight:normal;">请输入搜索关键字：</h4>',
                                        '<form id="BMapLib_formPoi" class="BMapLib_seBox"><input data-widget="quickdelete" id="BMapLib_PoiSearch" class="txtPoi" style="display:inline-block;*display:inline;*zoom:1;margin: 0 10px 0 15px;height:30px;line-height:30px;padding:0 10px;" type="search"/><button style="cursor:pointer;display:inline-block;*display:inline;*zoom:1;height:30px;padding:0 10px;" class="BMapLib_sc_t_b sc_btn" id="BMapLib_sc_b0">搜索</button></form>',
                                    '</td>',
                                '</tr>',
                            '</table>',
                        '</div>',
        ...
        , _initService: function () {
            ...
            this.localSearch = new BMap.LocalSearch(map, {
                renderOptions:{map: map,panel:"r-result",selectFirstResult:true}
         ...
         */
        , _bind: function () {
            var eventName = baidu.isMobile() ? "touchend" : "click"
                , me  = this;
        ...
        , _initCityTab : function () {
            ...
            citySelectDom.style.cssText = "position:absolute;top:0px;left:0px;background:#FAFAFA;left:0px;right:1px;overflow:hidden;height:162px;top:25px;border:1px solid #8C8C8C;display:none;";
            ...
            var html = '<div style="height:40px;line-height:40px;background:#8C8C8C;color:#fff;padding-left:10px;font-size:12px;"><span style="float:left;font-size:14px;">请选择具体城市</span><span style="float:right;padding:0 10px;cursor:pointer;" onclick="this.parentNode.parentNode.style.display=\'none\'">关闭</span></div>' +
            ...
            var cityTab = document.getElementById("BMapLib_cityTab");
            cityTab.appendChild(citySelectDom);
